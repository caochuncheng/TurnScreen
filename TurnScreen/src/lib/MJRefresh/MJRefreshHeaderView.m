...
- (void)updateTimeLabel
{
    ...
    if ([cmp1 day] == [cmp2 day]) { // 今天
        formatter.dateFormat = [NSString stringWithFormat:@"%@ HH:mm",MJRefreshHeaderToday ];
    ...
    // 3.显示日期
    _lastUpdateTimeLabel.text = [NSString stringWithFormat:@"%@%@", MJRefreshHeaderLastUpdate,time];
}
